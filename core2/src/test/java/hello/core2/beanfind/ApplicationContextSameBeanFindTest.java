...
//        MemberRepository bean = ac.getBean(MemberRepository.class);
    ...
    void findBeanByName(){
        MemberRepository meberRepository = ac.getBean("memberRepository1",MemberRepository.class);
        assertThat(meberRepository).isInstanceOf(MemoryMemberRepository.class);
    }

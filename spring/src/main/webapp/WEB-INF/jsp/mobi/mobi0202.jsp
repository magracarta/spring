...
<%------------------------------------------------------------------------------------------------------------------
-- 업   무 : 모바일관리 > 고객앱관리 > 버튼관리
-- 작성자 : 정선경
-- 최초 작성일 : 2023-07-10 17:44:22
------------------------------------------------------------------------------------------------------------------%>
<!DOCTYPE html>
<html>
<head>
	<jsp:include page="/WEB-INF/jsp/common/auiHeader.jsp"/>
	<link rel="stylesheet" type="text/css" href="/static/css/cApi/css/yk-mobile-customer.css" />
	<script type="text/javascript">
		...
		function goUpdate(frm) {
			$M.goNextPageAjaxSave(this_page+"/"+$M.getValue("c_btn_seq"), frm , { method : 'POST'},
				function(result) {
					if(result.success) {
						AUIGrid.setGridData(auiGrid, result.list);		
						goSearch();
		...
		function goSearchDetail(param) {
			...
			$M.goNextPageAjax(this_page + "/" + param.c_btn_seq, '', '',
				function(result) {
					if(result.success) {

	...
	<script type="text/javascript">
		...
		function createAUIGrid() {
			...
			var columnLayout = [
				...
				{
					//e_mon
					headerText: $M.getValue("s_year") + "년 " + $M.getValue("s_mon") + "월 ~ " + $M.getValue("e_year") + "년 " + $M.getValue("e_mon") + "월",
					children: [
						{
							// headerText:	($M.getValue("s_year") - 1) + "년",
							headerText:	"조회기간 실적",
						...
						{
							// headerText: $M.getValue("s_year") + "년",
							headerText:	"전년기간실적",
						...
						{
							// headerText: "비중(" + $M.getValue("s_year").substr(2,4) + ")",
							headerText: "비중(당년)",
							dataField: "a_gravity",
							width: "70",
							minWidth: "30",

...
<%------------------------------------------------------------------------------------------------------------------
-- 업   무 : 회계 > 장부 > 자산현황 및 재무제표 > null > null
-- 작성자 : 황빛찬
	...
	<div class="content-wrap">
		<div class="content-box">
			...
			<div class="contents">
				<ul class="tabs-c">
					<li class="tabs-item">
						<a href="#" class="tabs-link font-12 active" data-tab="inner1" id="tabBtn1">자산현황</a>
					</li>
					<li class="tabs-item">
						<a href="#" class="tabs-link font-12"  data-tab="inner2" id="tabBtn2">재무상태표</a>
					</li>
				</ul>
				<!-- /탭 -->

				<!-- /메인 타이틀 -->
				<div id="inner1" class="tabs-inner active"  style="height: 900px;">
					<iframe src="/acnt/acnt020601" id="contentFrame1" name="contentFrame" frameborder="0" style="width:100%; height: 100%;" scrolling="no"></iframe>
				</div>
				<div id="inner2" class="tabs-inner " style="height: 900px;">

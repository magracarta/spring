...
<%------------------------------------------------------------------------------------------------------------------
-- 업   무 : 회계 > 인사 > 인사관리 > null > 계산식업로드
-- 작성자 : 김상덕
-- 최초 작성일 : 2021-12-17 10:54:29
------------------------------------------------------------------------------------------------------------------%>
<!DOCTYPE html>
<html>
<head>
	...
	<script type="text/javascript">
		...
		function fnCheckGridEmpty() {
			return AUIGrid.validateGridData(auiGrid, ["mem_code", "col_01", "col_02"], "필수 항목은 반드시 값을 입력해야합니다.");
		}
...
// 			AUIGrid.clearGridData(auiGrid);
			...
			var msg = sYear + "년 " + sMon + "월 계산식을 삭제하시겠습니까?";
		...
		function fnDownloadExcel() {
			var exportProps = {
		  	...
		  	fnExportExcel(auiGrid, "계산식업로드", exportProps);
		}

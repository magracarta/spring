...
<%------------------------------------------------------------------------------------------------------------------
-- 업   무 : 부품 > 코드관리 > 부품CUBE > null > 부품SET상세
-- 작성자 : 박예진
	...
	//		}
		...
		function goModify() {
			...
			for(var i = 0; i < gridData.length; i++) {
				if(gridData[i].part_no != "" && gridData[i].part_use_yn == "Y") {
					cnt++;
				}
			}
			...
			for (var i = 0; i < gridData.length; i++) {
				...
				set_qty_arr.push(gridData[i].set_qty);
				set_remark_arr.push(gridData[i].set_remark);
			...
			var option = {
 			...
 			$M.setValue(frm, "set_qty_str", $M.getArrStr(set_qty_arr, option));
 			$M.setValue(frm, "set_remark_str", $M.getArrStr(set_remark_arr, option));
 			$M.setValue(frm, "part_use_yn_str", $M.getArrStr(use_yn_arr, option));
	    	
			$M.goNextPageAjaxModify("/part/part070301p01/save", frm, {method : 'POST'},
				function(result) {
			    	if(result.success) {
		    			opener.goSearch();
		    			location.reload();
	    ...
	    function goRemove() {
			var param = {
					"part_set_seq" : $M.getValue("part_set_seq")
			};
...
<input type="hidden" id="part_set_seq" name="part_set_seq" value="${map.part_set_seq}">
            ...
            <table class="table-border">
                ...
                <tbody>
                    <tr>
                        ...
                        <td colspan="3">
                            <input type="text" class="form-control essential-bg" id="set_name" name="set_name" alt="SET명" required="required" value="${map.set_name}">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <div class="form-row inline-pd widthfix">
                                <div class="col width120px">
                                    <input type="text" class="form-control text-right" readonly="readonly" id="vip_sale_price" name="vip_sale_price" value="${map.vip_sale_price}" format="decimal">
                                </div>
                        ...
                        <td>
                            <div class="form-row inline-pd widthfix">
                                <div class="col width120px">
                                    <input type="text" class="form-control text-right" readonly="readonly" id="total_vip_sale_price" name="total_vip_sale_price" value="${map.total_vip_sale_price}" format="decimal">
                                </div>
                                <div class="col width16px">원</div>
                            </div>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form-row inline-pd widthfix">
                                <div class="col width120px">
                                    <input type="text" class="form-control text-right" readonly="readonly" id="sale_price" name="sale_price" value="${map.sale_price}" format="decimal">
                                </div>
                                <div class="col width16px">원</div>
                            </div>
                        </td>
                        ...
                        <td>
                            <div class="form-row inline-pd widthfix">
                                <div class="col width120px">
                                    <input type="text" class="form-control text-right" readonly="readonly" id="total_sale_price" name="total_sale_price" value="${map.total_sale_price}" format="decimal">
                                </div>
                                <div class="col width16px">원</div>
                            </div>
                        </td>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <textarea class="form-control" style="height: 70px;" id="remark" name="remark">${map.remark}</textarea>
                        </td>
                    </tr>
                </tbody>
            </table>

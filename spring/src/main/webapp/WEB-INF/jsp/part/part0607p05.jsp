...
<%------------------------------------------------------------------------------------------------------------------
-- 업   무 : 부품 > 부품통계 > KPI집계 > null > 월간부품판매현황
-- 작성자 : 손광진
...
<head>
	...
	<script type="text/javascript">
		...
		function goSearch() {
			...
			$M.goNextPageAjax("/part/part060101/search", $M.toGetParam(param), {method : 'get'},
				function(result) {
					if(result.success) {
...
<!-- 검색영역 -->		
	<div class="content-box" style="border: none;">
		<div class="main-title" style="padding-left: 0">

...
<head>
	...
	function createAUIGrid() {
		...
		var columnLayout = [
			...
			{
				headerText: "등급",
				dataField: "mem_pnt_reprimand_name",
				width : "60",
				style : "aui-center",
				editable : false,
			},
			{
				headerText: "사유서<br>(스캔이미지)",
				dataField: "file_yn",
				width : "80",
				style : "aui-center",
				editable : false,
		...
		AUIGrid.bind(auiGrid, "cellClick", function(event){
			if(event.dataField == "mem_name") {
				...
				var popupOption = "";
				$M.goNextPage('/mmyy/mmyy011108p01', $M.toGetParam(param), {popupStatus : popupOption});
			}
		});
	}
	...
	function fnExcelDownload() {
	  // 엑셀 내보내기 속성
	  var exportProps = {};
	  fnExportExcel(auiGrid, "사유서", exportProps);
	}
	...
	// 사유서 작성
	function goNew() {
		$M.goNextPage('/mmyy/mmyy01110801');
	}
	</script>
</head>

...
<%------------------------------------------------------------------------------------------------------------------
-- 업   무 : MY > MY > 법인카드 사용이력 > null > 카드사용내역상세
-- 작성자 : 박준영
-- 최초 작성일 : 2020-05-18 10:41:27
------------------------------------------------------------------------------------------------------------------%>
<!DOCTYPE html>
<html>
<head>
	...
	<script type="text/javascript">
		...
		function fnDetail() {
			...
			var popupOption = "";
			$M.goNextPage('/comp/comp0902', $M.toGetParam(param), {popupStatus: popupOption});
		}
			...
			<div>
				...
				<table class="table-border mt5">
						...
						<td>
							<div class="dpf algin-item-center">
								...
								<div class="input-group width120px mr10">					
									<input type="text" class="form-control border-right-0 width100px"  id="job_report_no" name="job_report_no"  value="${bean.job_report_no}"   readonly="readonly" >
								...
								<div class="form-check form-check-inline">
									<input class="form-check-input" type="radio" name="card_use_cd"  value="03" ${bean.card_use_cd == '03'? 'checked="checked"' : ''}>
									<label class="form-check-label">수주</label>
								</div>
								<div class="input-group width120px">
									<input type="text" class="form-control border-right-0 width100px"  id="part_sale_no" name="part_sale_no"  value="${bean.part_sale_no}"    readonly="readonly" >
					...
					<tr>
						...
						<td>
							<input type="text" class="form-control width120px" id="chain_no" name="chain_no"  value="${bean.chain_no}" readonly="readonly"  >
						</td>
					</tr>
					<tr>
						<th class="text-right">사업자번호</th>
						<td>
							<input type="text" class="form-control width120px" id="chain_id" name="chain_id"  value="${bean.chain_id}" readonly="readonly"  >
						</td>
					</tr>
					<tr>

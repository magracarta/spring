...
<head>
	...
	<script type="text/javascript">
		...
		var auiGridIds = {
			ORDER : "auiGridinner1",
			PARTINOUT : "auiGridinner2",
			INOUTDOC : "auiGridinner3",
			ADJUST : "auiGridinner4",
			TRANS : "auiGridinner5",
			PARTSEND : "auiGridinner6"
		}
		...
		function goSearchTab(id) {
			...
			$M.goNextPageAjax("/mmyy/mmyy0103p04/"+tabId, $M.toGetParam(param), {method : 'get', loader : false},
				function(result) {
              	...
              	<div>
	               <div class="title-wrap">
	                  ...
	                  <ul class="tabs-c mt5" style="flex-grow: 1;">
	                      <li class="tabs-item">
	                          <a href="#" class="tabs-link font-12 active" data-tab="ORDER" >발주 (${orderCnt eq undefined ? 0 : orderCnt})</a>
	                      </li>
	                      <li class="tabs-item">
	                          <a href="#" class="tabs-link font-12" data-tab="PARTINOUT" >매입처리 (${partInoutCnt eq undefined ? 0 : partInoutCnt})</a>
	                      </li>
	                      <li class="tabs-item">
	                          <a href="#" class="tabs-link font-12" data-tab="INOUTDOC" >매출처리 (${inoutDocCnt eq undefined ? 0 : inoutDocCnt})</a>
	                      </li>
	                      <li class="tabs-item">
	                          <a href="#" class="tabs-link font-12" data-tab="ADJUST" >재고조정 (${adjustCnt eq undefined ? 0 : adjustCnt})</a>
	                      </li>
	                      <li class="tabs-item">
	                          <a href="#" class="tabs-link font-12" data-tab="TRANS" >이동처리 (${transCnt eq undefined ? 0 : transCnt})</a>
	                      </li>
	                       <li class="tabs-item">
	                          <a href="#" class="tabs-link font-12" data-tab="PARTSEND" >발송처리 (${partSendCnt eq undefined ? 0 : partSendCnt})</a>
	                      </li>
	                  </ul>
	                  <!-- /탭 -->
	
					<!-- /메인 타이틀 -->
					<div id="ORDER" class="tabs-inner active">
						<jsp:include page="/WEB-INF/jsp/mmyy/mmyy0103p0401.jsp?s_mem_no=${inputParam.s_mem_no}&s_work_dt=${inputParam.s_work_dt}"/>	
					</div>
					<div id="PARTINOUT" class="tabs-inner">
						<jsp:include page="/WEB-INF/jsp/mmyy/mmyy0103p0402.jsp?s_mem_no=${inputParam.s_mem_no}&s_work_dt=${inputParam.s_work_dt}"/>	
						</div>
					<div id="INOUTDOC" class="tabs-inner">
						<jsp:include page="/WEB-INF/jsp/mmyy/mmyy0103p0403.jsp?s_mem_no=${inputParam.s_mem_no}&s_work_dt=${inputParam.s_work_dt}"/>	
					</div>
					<div id="ADJUST" class="tabs-inner">
						<jsp:include page="/WEB-INF/jsp/mmyy/mmyy0103p0404.jsp?s_mem_no=${inputParam.s_mem_no}&s_work_dt=${inputParam.s_work_dt}"/>	
					</div>
					<div id="TRANS" class="tabs-inner">
						<jsp:include page="/WEB-INF/jsp/mmyy/mmyy0103p0405.jsp?s_mem_no=${inputParam.s_mem_no}&s_work_dt=${inputParam.s_work_dt}"/>	
					</div>
					<div id="PARTSEND" class="tabs-inner">
						<jsp:include page="/WEB-INF/jsp/mmyy/mmyy0103p0406.jsp?s_mem_no=${inputParam.s_mem_no}&s_work_dt=${inputParam.s_work_dt}"/>	
					</div>
		            <div class="row">
		                <div class="col-7">
		                    <!-- 전일미결사항 -->

...
<head>
	...
	// 업무품의서 등록
	function goNew() {
		$M.goNextPage("/mmyy/mmyy01110901");
	}
	...
	function goSearch() {
		var param = {
			...
			"s_doc_job_cd" : $M.getValue("s_doc_job_cd"),
	...
	function fnExcelDownload() {
	  // 엑셀 내보내기 속성
	  var exportProps = {};
	  fnExportExcel(auiGrid, "업무품의서", exportProps);
	}
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr>							
                                    ...
                                    <th>업무구분</th>
                                    <td>
										<select class="form-control" id="s_doc_job_cd" name="s_doc_job_cd">
											<option value="">- 선택 -</option>
											<c:forEach items="${codeMap['DOC_JOB']}" var="item">

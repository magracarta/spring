...
<%------------------------------------------------------------------------------------------------------------------
-- 업   무 : MY > MY > 기안문서 > 사후사고보고 > null
-- 작성자 : 황빛찬
-- 최초 작성일 : 2025-02-03 14:00:00
------------------------------------------------------------------------------------------------------------------%>
<!DOCTYPE html>
<html>
<head>
...
<script type="text/javascript">
	...
	function createAUIGrid() {
		...
		AUIGrid.bind(auiGrid, "cellClick", function(event){
			...
			if (event.dataField === "mem_name") {
				...
				$M.goNextPage('/mmyy/mmyy011111p01', $M.toGetParam(param), {popupStatus : ""});
			}
		});
	}
	...
	function goSearch() {
		var param = {
			...
			s_mem_name : $M.getValue("s_mem_name"), // 작성자
	...
	function fnDownloadExcel() {
	  // 엑셀 내보내기 속성
	  var exportProps = {};
	  fnExportExcel(auiGrid, "사후사고보고", exportProps);
	}
	...
	// 사후사고보고서 작성 화면 이동
	function goNew() {
		$M.goNextPage('/mmyy/mmyy01111101');
	}

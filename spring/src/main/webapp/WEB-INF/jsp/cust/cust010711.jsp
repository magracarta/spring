...
// 			fnInit();
		...
		function enter(fieldObj) {
			var field = ["s_cust_name", "s_machine_name"];
			$.each(field, function() {
...
<%--			</c:if>--%>
		...
		function goSearch() {
			...
			var param = {
				...
				s_rfq_type_cd : "MACHINE",
				s_request_status_name : $M.getValue("s_request_status_name"),
								...
								<tr>
									<td>
										<select class="form-control" id="s_date_type" name="s_date_type">
											...
											<option value="request_dt">고객요청일</option>
										</select>
									</td>
									<td>
...
<%--									</td>									--%>
									...
									<th>모델명</th>
									<td>
										<input type="text" class="form-control" name="s_machine_name" id="s_machine_name">
									</td>
									<th>메이커</th>
									<td>
									...
									<th>상태</th>
									<td>
										<select class="form-control" id="s_request_status_name" name="s_request_status_name">
											<option value="">- 전체 -</option>
...
<%--&lt;%&ndash;											<c:if test="${SecureUser.org_type ne 'AGENCY'}">&ndash;%&gt;--%>
<%--											<c:if test="${page.fnc.F00033_001 ne 'Y'}">--%>
<%--												<option value="">- 전체 -</option>--%>
...
<%--												</c:forEach>--%>
<%--											</c:if>--%>
<%--&lt;%&ndash;											<c:if test="${SecureUser.org_type eq 'AGENCY'}">&ndash;%&gt;--%>
<%--											<c:if test="${page.fnc.F00033_001 eq 'Y'}">--%>

...
<%------------------------------------------------------------------------------------------------------------------
-- 업   무 : 고객 > 거래현황 > 임의비용처리-출하 > null > null
-- 작성자 : 박예진
			...
			<div class="content-box">
				...
				<div class="contents">
					...
					<div id="inner1" class="tabs-inner active"  style="height: 850px;">
						<iframe src="/cust/cust030401" id="contentFrame1" name="contentFrame" frameborder="0" style="width:100%; height: 100%;" scrolling="no" onload="fnLoadFrame(0)"></iframe>
					</div>
					<div id="inner2" class="tabs-inner " style="height: 850px;">
						<iframe src="/cust/cust030402" id="contentFrame2" name="contentFrame" frameborder="0" style="width:100%; height: 100%;" scrolling="no" onload="fnLoadFrame(1)"></iframe>
					</div>
				</div>
			</div>

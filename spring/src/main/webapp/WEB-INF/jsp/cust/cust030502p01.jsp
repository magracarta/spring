...
<%------------------------------------------------------------------------------------------------------------------
-- 업   무 : 고객 > 거래현황 > 쿠폰사용내역 > 서비스쿠폰 > 무상쿠폰 임의발행
-- 작성자 : 정재호
...
<script type="text/javascript">
  ...
  function onChangeCouponType(value) {
    ...
    $M.goNextPageAjax(this_page + "/bodyNoSearch", $M.toGetParam(param), {method: 'GET'},
      function (result) {
        if (result.success) {
          // 차대번호 리스트 셋팅
...
<form id="main_form" name="main_form">
  <input type="hidden" id="cust_svc_coupon_no" name="cust_svc_coupon_no" value=""/>
  <!-- 팝업 -->
        ...
        <div>
          <table class="table-border mt5">
            ...
            <tr>
              ...
              <td>
                <div class="input-group">
                  <input type="text" class="form-control border-right-0 width100px" id="cust_name" name="cust_name"
                         required="required" readonly="readonly" alt="고객명"/>
              ...
              <td>
                <input type="text" class="form-control width120px" id="auto_name" name="auto_name" value="임의발행"
            ...
            <tr class="cust-tr cust-step2">
              ...
              <td>
                <select id="svc_coupon_no" name="svc_coupon_no" class="form-control essential-bg" required="required"
                        alt="쿠폰종류"
              ...
              <td>
                <input type="text" class="form-control width120px" id="cust_type_name" name="cust_type_name" value=""
            ...
            <tr class="cust-tr cust-step3">
              ...
              <td colspan="3">
                <input type="hidden" id="machine_seq" value=""/>
                <select id="body_no" name="body_no" class="form-control essential-bg" required="required"
                        alt="차대번호"
            ...
            <tr class="cust-tr cust-step3">
              ...
              <td>
                <div class="input-group width120px">
                  <input type="text" class="form-control border-right-0 essential-bg calDate" id="issue_dt"
                         name="issue_dt"

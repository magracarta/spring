...
<%------------------------------------------------------------------------------------------------------------------
-- 업   무 : 서비스 > 서비스관리 > 서비스업무평가-개인 > null > null
-- 작성자 : 손광진
-- 최초 작성일 : 2020-04-08 09:08:29
------------------------------------------------------------------------------------------------------------------%>
<!DOCTYPE html>
<html>
<head>
    ...
    <script type="text/javascript">
        ...
        function createAUIGrid() {
            ...
            var columnLayout = [
                ...
                {
                    headerText: "전년도<br>총정비시간<br>(총이동+총정비<br>+렌탈업무시간)",
                ...
                {
                    headerText: "총정비시간<br>(총이동+총정비<br>+렌탈업무시간)",
            ...
            AUIGrid.bind(auiGrid, "footerClick", function( event ) {
            	...
            	case 14:	// 총정비시간(이동정+정비)
					...
					var params = {
		                ...
		                "s_center_code": $M.getValue("s_center_code"),
		                "s_mem_name": $M.getValue("s_mem_name"),
		                "before_yn" : event.footerIndex == 13 ? "Y" : "N", 	// 전년도일때 
					}
            ...
            AUIGrid.bind(auiGrid, "cellClick", function (event) {
                ...
                } else if (event.dataField == "free_part_amt" || event.dataField == "free_travel_amt" || event.dataField == "free_work_amt") {
                    // 무상정비금액 - 부품비/출장비/공임
                    type = "";

...
<%------------------------------------------------------------------------------------------------------------------
-- 업   무 : 서비스 > 고객관리 > 전화업무 통합관리 > DI Call > null
-- 작성자 : 최보성
...
<head>
	...
	<script type="text/javascript">
		...
		function fnSearch(successFunc) {
			...
			var sWorkGubun = "${inputParam.s_work_gubun}";
			// if((sTreatYn == "" || sTreatYn == null) && sWorkGubun != "Y") {
			if(sWorkGubun != "Y") {
				sTotalSearch = "A";
			}
									...
									<div class="form-row inline-pd widthfix">
										<div class="col-5">
											<div class="input-group">
												<input type="text" class="form-control border-right-0 calDate" id="s_start_dt" name="s_start_dt" dateFormat="yyyy-MM-dd" alt="출하 시작일" value="${inputParam.s_start_dt}">
											</div>
										</div>
										<div class="col-auto">~</div>
										<div class="col-5">
											<div class="input-group">
												<input type="text" class="form-control border-right-0 calDate" id="s_end_dt" name="s_end_dt" dateFormat="yyyy-MM-dd" alt="출하 완료일" value="${inputParam.s_end_dt}">
											</div>
										</div>
									</div>
								</td>

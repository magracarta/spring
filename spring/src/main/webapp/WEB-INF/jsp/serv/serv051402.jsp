...
<head>
	...
	<script type="text/javascript">
		...
		function goSearch() {
			...
			$M.goNextPageAjax("/serv/serv051401/search", $M.toGetParam(param), {method: 'get'},
					function (result) {
						if (result.success) {
		...
		function fnDownloadExcel() {
			fnExportExcel(auiGrid, '신)서비스업무평가-센터-전년도매출현황');
		}
...
<input type="hidden" id="s_year_val" name="s_year_val">
<input type="hidden" id="s_mon_val" name="s_mon_val">
<input type="hidden" id="s_end_year_val" name="s_end_year_val">
<input type="hidden" id="s_end_mon_val" name="s_end_mon_val">
							...
							<tr>
								...
								<td>
									<div class="form-row inline-pd">
										<div class="col-auto">
											<select class="form-control" id="s_start_year" name="s_start_year" readonly="readonly">
										...
										<div class="col-auto">
											<select class="form-control" id="s_start_mon" name="s_start_mon" readonly="readonly">
										...
										<div class="col-auto">
											<select class="form-control" id="s_end_year" name="s_end_year" readonly="readonly">
												<c:forEach var="i" begin="2000" end="${inputParam.s_current_year}" step="1">
													<c:set var="year_option" value="${inputParam.s_current_year - i + 2000}" />
										...
										<div class="col-auto">
											<select class="form-control" id="s_end_mon" name="s_end_mon" readonly="readonly">
												<c:forEach var="i" begin="1" end="12" step="1">

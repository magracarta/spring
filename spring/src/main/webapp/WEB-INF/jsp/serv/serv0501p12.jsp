...
<%------------------------------------------------------------------------------------------------------------------
-- 업   무 : 서비스 > 서비스관리 > 서비스업무평가-개인 > null > 신차판매리스트
-- 작성자 : 담당자 이름을 넣어주세요.
...
<head>
    ...
    <script type="text/javascript">
        ...
        function fnInit() {
           ...
           if(pageType == "center") {
               AUIGrid.hideColumnByDataField(auiGrid, ["mem_name"]);
           } else if(pageType == "personal") {
               AUIGrid.hideColumnByDataField(auiGrid, ["org_name"]);
           }
        }

        //엑셀다운로드
        function fnExcelDownload() {
            fnExportExcel(auiGrid, "감가 이력 리스트");
        }

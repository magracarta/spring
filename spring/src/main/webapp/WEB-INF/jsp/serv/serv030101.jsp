...
<%------------------------------------------------------------------------------------------------------------------
-- 업   무 : 서비스 > 쿠폰관리 > 서비스 쿠폰관리 > 쿠폰신규발행 > null
...
<head>
  ...
  <script type="text/javascript">
    ...
    function goSave() {
      ...
      $M.goNextPageAjaxSave("/serv/serv0301" + '/save', $M.toGetParam(param), {method: 'POST'},
        function (result) {
          if (result.success) {
            fnBack();
          }
      ...
      <div class="content-box">
        <div class="main-title detail">
          <div class="detail-left">
            <button type="button" class="btn btn-outline-light" onclick="javascript:fnBack();">
              <i class="material-iconskeyboard_backspace text-default"></i>
            </button>
              ...
              <div>
                <table class="table-border">
                  ...
                  <tr>
                    ...
                    <td>
                      <input type="text" class="form-control" id="svc_coupon_name" name="svc_coupon_name"
                             required="required" alt="쿠폰명">
                    </td>
                    <th class="text-right essential-item">쿠폰표기명</th>
                    <td>
                      <input type="text" class="form-control" id="svc_disp_coupon_name" name="svc_disp_coupon_name"
                  ...
                  <tr>
                    ...
                    <td colspan="3">
                      <input type="text" class="form-control" id="scope_text" name="scope_text" alt="포함범위">
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>
                      <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" id="mch_type_c" name="mch_type_cad" value="C" alt="장비계약" required="required" checked>
                    ...
                    <td>
                      <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="out_apply_yn" id="out_apply_y" value="Y" onchange="fnOutApplyChange(this.value)"
                               alt="출하시지급여부" required="required" checked>
                  ...
                  <tr class="event-tr event-step2">
                    ...
                    <td colspan="3">
                      <div class="input-group width100px">
                        <input type="text" class="form-control border-right-0 calDate" id="out_evt_st_dt" name="out_evt_st_dt" dateFormat="yyyy-MM-dd" alt="이벤트시작일자">
                      </div>
                    </td>
                  </tr>
                  <tr class="event-tr event-step3">
                    ...
                    <td colspan="3">
                      <div class="input-group width100px">
                        <input type="text" class="form-control border-right-0 calDate" id="out_evt_ed_dt" name="out_evt_ed_dt" dateFormat="yyyy-MM-dd" alt="이벤트종료일자">
                      </div>
                    </td>
                  </tr>
                  </tbody>

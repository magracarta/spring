...
<%------------------------------------------------------------------------------------------------------------------
-- 업   무 : 서비스 > 서비스관리 > 서비스업무평가-센터 > 실적분석 > 렌탈 순익 변화추이
-- 작성자 : 성현우
...
<head>
	...
	<script type="text/javascript">
		...
		var rentalProfitAmt = ${listJson}; // 렌탈 순익 데이터
		var maxAmt = ${maxAmt};
		console.log(maxAmt);
				...
				for (var i = 0; i < itemLength; ++i) {
					...
					for (var prop in row) {
						if (prop == "yyyymm") {
							...
							dataArray[index] += $M.toNum(row["rental_profit_amt"]);
						}
					}
				}

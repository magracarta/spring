...
<%------------------------------------------------------------------------------------------------------------------
-- 업   무 : 공통 > 회계 > 자주쓰는계정관리 > null > null
-- 작성자 : 손광진
-- 최초 작성일 : 2020-05-06 13:13:47
------------------------------------------------------------------------------------------------------------------%>
<!DOCTYPE html>
<html>
<head>
	...
	<script type="text/javascript">
		...
		function fnSetAccountInfo(data) {
			...
			if(rowItems.length > 0 ) {
	    		...
	    		item.acnt_code = "";
	    		item.acnt_name = "";
	    		item.bookmark_mng_code = "";
	    		item.bookmark_yn = "Y";
	    		item.bookmark_use_yn = "Y";

...
<head>
	...
	<script type="text/javascript">
		...
		function createAUIGrid() {
			...
			AUIGrid.bind(auiGrid, "cellClick", function(event) {
				if(event.dataField == 'title'){
					...
					var param = {
							sms_attach_seq : event.item.sms_attach_seq
					}
					$M.goNextPage('/comm/comm0113p01', $M.toGetParam(param), {popupStatus : poppupOption});
				}
			});
			// 그리드 갱신
		...
		function fnDownloadExcel() {
			  // 엑셀 내보내기 속성
			  var exportProps = {};
			  fnExportExcel(auiGrid, "MMS파일관리", exportProps);
		}
	</script>
</head>
<body>
